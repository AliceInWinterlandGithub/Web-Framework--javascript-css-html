...
var WindowSystem = (function() {
    var log = function(message) {
        this.debug && console.log("WindowSystem: " + 
				  Date.now() + ": " + 
				  message);
    };
    var error = function(message) {
        console.error("WindowSystem: " + Date.now() + ": " + message);
    };
...
x = new WindowSystem(WindowSystemDefaults);
...
x.registerApplication("WindowSystem", WindowSystem);
